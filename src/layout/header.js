                ...
                <div className='container'>
                    ...
                    <div className={`header-nav ${burger ? 'phone-menu' : ""}`}>
                        <ul className={`header-nav__menu ${burger ? 'phone' : ""}`}>
                            ...
                            <li className='header-nav__item'><a href='#' className='header-nav__link'>Categories</a></li>
                            <li className='header-nav__item'><a href='#' className='header-nav__link'>About us</a></li>
                            <li className='header-nav__item'><a href='#' className='header-nav__link'>Blog</a></li>
                            <li className='header-nav__item'><a href='#' className='header-nav__link'>Login</a></li>
                        </ul>
                        <div className='header-nav__creator'>
                            <a href='#' class='header-nav__btn header-nav__link'>For creators</a>
                        </div>
                    </div>
