      ...
      <div className="featured-post-content">
        <div className="featured-post__date">
          <div className="featured-post__date__img">
            <img
              src={`/assets/images/${props.info.date.dateImgUrl}`}
              alt="OK"
        ...
        <div className="featured-post__main">
          <h5 className="featured-post__author">
            By&nbsp;<span>&nbsp;{props.info.author}</span>
            <span>
              {props.info.date.day}&nbsp;{props.info.date.month}&nbsp;
              {props.info.date.year}
            </span>
          </h5>
          {props.info.title ? (
          ...
          {props.info.description ? (
            <p className="featured-post__desc">{props.info.description}</p>
          ) : null}
          {props.info.readmore ? (
          ...
          {props.info.imgSmUrl ? (
            <img
              src={`/assets/images/${props.info.imgSmUrl}`}
              className="img-sm"
            />
          ) : null}
          {props.info.feedbacks
            ? props.info.feedbacks.map((item, index) => (
                <div className="featured-post__feedback" key={index}>
                  ...
                  <div className="feedback-image">
                    <img
                      src={`/assets/images/${item.feedImgUrl}`}
                      alt="feedback image"
                    ></img>
                  </div>
                </div>
