    ...
    <div className="post">
      <div className="post-heading">
        <div className="post-heading__author">
          <p>
            By&nbsp;
            <span className="author-name">{props.info.author}</span>
            &nbsp;|&nbsp;<span className="author-date">{props.info.date}</span>
          </p>
        </div>
      ...
      <div className="post-content">
        <p className="post-content__desc">
          {props.info.description}
          <a href="twiiter.com" className="btn-twit">
            Twit..
          </a>
        </p>
